/* Minimal stroke icons (20px grid), inherit currentColor. */
const base = {
  width: 18,
  height: 18,
  viewBox: "0 0 24 24",
...
export const IconAlert = (p) => (
  <svg {...base} {...p}><path d="M10.3 3.6 2 18a2 2 0 0 0 1.7 3h16.6A2 2 0 0 0 22 18L13.7 3.6a2 2 0 0 0-3.4 0Z" /><path d="M12 9v4M12 17h.01" /></svg>
);
